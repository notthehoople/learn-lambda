...
def s3_thumbnail_generator(event, context):
    ...
    # TODO
    # - Handle Errors (e.g. corrupted images; non image files)
    # - Make sure we correctly measure timeouts
    # - Do not create a thumbnail if the image is too big (e.g. over 5MB)
    # - Build alerting using AWS SNS if an image is not successfully processed
    # - Put image metadata into DynamoDB
    
    print(event)    # Prints the event details. Always start with this when beginning development
